...
export const Roles: Record<number, Role> = {
	[RoleTypes.ADMIN]: { id: '2529', label: 'admin', level: 50, promotable: true },
	[RoleTypes.MODERATOR]: { id: '5337', label: 'moderator', level: 40, promotable: true },
	[RoleTypes.PRESENTER]: { id: '9583', label: 'presenter', level: 30, promotable: true },
	[RoleTypes.AUTHENTICATED]: { id: '5714', label: 'authenticated', level: 20, promotable: false },
	[RoleTypes.NORMAL]: { id: '4261', label: 'normal', level: 10, promotable: false },
};