...
import { botDisplayName, botIdFromUrl, botSessionFromUrl, botTokenFromUrl, botTypeFromUrl, HEADLESS_PRESET, headlessFromUrl, headlessJoinPlan, hrefWithoutBotToken, layoutSettingsActions } from '../../utils/headless';
...
const Join = ({ roomId }: JoinProps): React.JSX.Element | null => {
	...
	useEffect(() => {
		...
		dispatch(meActions.setBotId(botIdFromUrl(window.location.href)));
